  ...
  <div class="row">
    <div class="col-sm">
        <div class="card" style="width: 18rem; height:20rem">
            ...
            <div class="card-body">
                ...
                <a href="relatorioEmpregados.php" class="btn btn-info">Listar</a>       
                <a href="cadastroEmpregado.php" class="btn btn-primary">Cadastrar</a>
            </div>
        </div>
    </div>
    <div class="col-sm">
    <div class="card" style="width: 18rem; height:20rem">
            ...
            <div class="card-body">
                ...
                <a href="relatorioDepartamento.php" class="btn btn-info">Listar</a>
                <a href="cadastroDepartamento.php" class="btn btn-primary">Cadastrar</a>
            </div>
        </div>
    </div>
    <div class="col-sm">
    <div class="card" style="width: 18rem; height: 20rem;">
            ...
            <div class="card-body">
                ...
                <a href="relatorioProjeto.php" class="btn btn-info">Listar</a>
                <a href="cadastroProjeto.php" class="btn btn-primary">Cadastrar</a>
            </div>
        </div>
    </div>
  </div>
