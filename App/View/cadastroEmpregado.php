    ...
    <div class="col-md-12" id="div_form">
        <form action="../Controller/EmpregadoController.php" method="POST">
            <fieldset>
                ...
                <div class="form-group">
                    <label for="selectProj">Selecione os projetos onde o Empregado está alocado</label>
                ...
                <label for="selectProj">Selecione a carga horária do empregado neste projeto</label>
