...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <a class="navbar-brand" href="inicio.php">Projeta System</a>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          ...
          <a class="dropdown-item" href="relatorioEmpregados.php">Listagem de Empregados</a>
          <div class="dropdown-divider"></div>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          ...
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="cadastroDependente.php">Dependentes Financeiros</a>
          <div class="dropdown-divider"></div>
        </div>
      </li>
    </ul>
