...
<div class="container">
    <div class="col-md-12" id="div_form">
        <form action="../Controller/DependenteFinanceiroController.php" method="POST">
            <fieldset>
                <legend>Cadastro de Dependentes Financeiros</legend>
                ...
                <div class="form-group">
                    <label for="selectTipo">Selecione o grau de parentesco do dependente</label>
